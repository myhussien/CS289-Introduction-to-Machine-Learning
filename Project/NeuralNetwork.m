...
% trainLabel=[];
% for i=1:100
%     trainDataRaw=[trainDataRaw;reshape(train_pic1(((i-1)*8+1):(i*8)),1,70)];
%     trainDataRaw=[trainDataRaw;reshape(train_pic2(((i-1)*8+1):(i*8)),1,70)];
%     trainDataRaw=[trainDataRaw;reshape(train_pic4(((i-1)*8+1):(i*8)),1,70)];
%     trainDataRaw=[trainDataRaw;reshape(train_pic5(((i-1)*8+1):(i*8)),1,70)];
%     if mod(i,2)==1
