...
trainLabelRaw=[train_pic_label1;train_pic_label2;train_pic_label4;train_pic_label5];
...
for i=1:(size(trainDataRaw,1));
    if (mod(i,8)<4)&&(mod(i,8)>0)
        trainData=[trainData;trainDataRaw(i,:)];
        trainLabel=[trainLabel;trainLabelRaw(i)];
    end
end
n=length(trainLabel);
indx=randsample(n,n);
