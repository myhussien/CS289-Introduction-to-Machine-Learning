...
prevLossL=1;
for iter=1:M
    [mui,beta]=stochGradDescentIter(XtrainL,ytrain,beta,alphaL,lambdaL,iter);
    muL=[muL mui];
...
title('Stochastic Gradient Descent Method using data preprocessed using ii)');
xlabel('Iteration');
ylabel('Loss');
saveas(P3L,'p3Lstoch.jpg');
