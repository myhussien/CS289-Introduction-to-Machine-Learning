...
prevLossI=1;
for iter=1:M
    [mui,beta]=stochGradDescentIter(XtrainI,ytrain,beta,alphaI,lambdaI,iter);
    muI=[muI mui];
...
title('Stothascic Gradient Descent Method using data preprocessed using iii)');
xlabel('Iteration');
ylabel('Loss');
saveas(P3I,'p3istoch.jpg');
